...
# Examples of units.
# Written by: Eric J. Whitney  Last updated: 14 January 2022
...
print(f"Air density = {air_density:5G} [{air_density.convert('kg/m^3'):5G}]")

cl_max = 1.35
takeoff_mass = dim(300, 'kg')
print(f"Takeoff mass = {takeoff_mass:.5G} [{takeoff_mass.convert('lbm'):.5G}]")
...
print(f"Stall speed = {stall_speed:.5G} [{stall_speed.convert('ft/s'):.5G}] "
