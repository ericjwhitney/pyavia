...
Reference propeller 5868-9 from NACA Report No. 658, note:
    ...
    - B = 3 blades.
    - R = 5.0' / 1.524 m.
    - β data is given for condition where β=0° at x=0.75 determined by
      subtraction from 35° data.
...
β = np.deg2rad(_5868_9_GEO[:, 3]).tolist()
...
DATA_SETS = {
    15: [  # β0 [°] @ x=0.75.
        # Cols: J, η, C_T, C_P, RPM, V∞ [fps]
        [0.000, 0.000, 0.140, 0.060, 1000.0, 0.00],
    ...
    25: [
        [0.000, 0.000, 0.160, 0.149, 800.0, 0.00],
    ...
    35: [
        [0.000, 0.000, 0.174, 0.263, 800.0, 0.00],
    ...
    55: [
        [0.000, 0.000, 0.159, 0.482, 600.0, 0.00],
